...
- [x] Секция формы (14): фон `beach_sunset` (Sprint 6: замена битого `cta_sunset`), glass-панель, логотип, поля читаемы на 1440 / 768 / 375 — скрины: `qa_sprint3b_form_1440.png`, `_768`, `_375`
