...
REPLACEMENTS = [
    ...
    ('<title>Satva Samui — Йога-тур в Таиланд | 75$ в сутки, всё включено</title>',
     '<title>Satva Samui — Yoga Retreat Koh Samui, Thailand | From $75/night All-Inclusive</title>'),
    ('content="Йога-тур в Таиланд на острове Самуи от 75$ в сутки. Включает проживание у моря, 2 йоги в день, завтрак и обед, диагностику по пульсу. Процедуры аюрведы — по запросу, за доп. плату."',
     'content="Beachfront yoga retreat on Koh Samui, Thailand from $75/night. Includes accommodation steps from the sea, twice-daily yoga, breakfast &amp; lunch, and Ayurvedic health consultation."'),
    ...
    ('content="Satva Samui — Йога-тур в Таиланд | от 75$ в сутки"',
     'content="Satva Samui Yoga Retreat — Koh Samui, Thailand | From $75/night"'),
    ('content="Йога, пляж, здоровое питание и диагностика по пульсу. От 75$ в сутки. Процедуры — дополнительно, по запросу."',
     'content="Beachfront yoga, nourishing meals, and Ayurvedic pulse reading. From $75/night. Wellness programmes available on request."'),
